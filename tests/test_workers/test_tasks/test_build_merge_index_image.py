...
def test_is_bundle_version_valid_invalid_ocp_version():
    match_str = 'Invalid ocp_version "random-version" specified for target_index'
    with pytest.raises(IIBError, match=match_str):
        build_merge_index_image.is_bundle_version_valid('some_bundle', 'random-version')
